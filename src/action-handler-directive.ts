...
// DONE You need to replace all instances of "action-handler-donder-header" with "action-handler-<your card name>"
customElements.define('action-handler-donder-header', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-donder-header')) {
    return body.querySelector('action-handler-donder-header') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-donder-header');
